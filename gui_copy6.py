...
def process_lazzo_image(img_path,blur_val,cann,size,dst_val,factor,scale):
	...
	for c in contours:
			...
			if cv2.contourArea(c) > 1 and cv2.contourArea(c) < (x*y)/4:
				...
				if l > size:
								cv2.drawContours(temp_image,[c], 0, color,1)
				'''((x, y), r) = cv2.minEnclosingCircle(c)
...
def draw_lazzo(path, factor,size,scale):
	...
	for c in fine_cnts:
				...
				if cv2.contourArea(c) > 1 and cv2.contourArea(c) < (x*y)/4:
					...
					l = round(2*r*factor,2)
					if l > size:
						cv2.drawContours(temp_image,[c], 0, (0,0,255),1)
...
def drawing_contour_lazzo(img):
		...
		def line_drawing(event,x,y,flags,param):#, drawing = False,pt1_x = None,pt1_y = None):
				...
				if event==cv2.EVENT_LBUTTONDOWN:
						...
						if drawing==True:
								cv2.line(img,(pt1_x,pt1_y),(x,y),color=(255,0,0),thickness=1)
								pt1_x,pt1_y=x,y
								#print(pt1_x,pt1_y)
								contour_points.append([[pt1_x,pt1_y]])
...
def plot():
	...
	fig.suptitle(main_time,ha = 'right',style='italic',x=0.55)
	fig.linewidth = 0.1
	#-------------------------------------------------
	...
	if fine_tot != float(0):
		...
		axs[1].text(-0.08, 0.03, s, horizontalalignment='left', fontsize = 'x-small',style='italic')
	...
	img3=img2.resize((1005, 705), Image.ANTIALIAS)  
...
root.iconbitmap(r'C:\Users\USER\NEW BUTTONS 5\tot_v8\Input\Indian-Oil-jobs.ico')     # .ico file located inside Input Folder
...
page0=LabelFrame(root,background='white')
...
#-----------------------------------------------------------------Page0
canvas = Canvas(page0, width= 700, height=850, bg="white",highlightbackground='white')
canvas.grid(row=0,column=0,padx=405,rowspan=8)

img2= Image.open(r'C:\Users\USER\NEW BUTTONS 5\tot_v8\Button images\nice_logo_white.PNG')
img3=img2.resize((700, 850), Image.ANTIALIAS)  
canvas.image_tk = ImageTk.PhotoImage(img3)
image_id = canvas.create_image(0,0, anchor="nw",image=canvas.image_tk)
canvas.itemconfigure(image_id, image=canvas.image_tk)

all_btn = PhotoImage(file=r'C:\Users\USER\NEW BUTTONS 5\tot_v8\Button images\button_select-image (4).png')
#bt1 = Button(page0, text="Select Image",font="Calibri 19 ",command=select_image,image=all_btn,borderwidth=0,bg='black',activebackground='black')
...
next_btn = PhotoImage(file=r'C:\Users\USER\NEW BUTTONS 5\tot_v8\Button images\icons8-next-page-100 (1).png')
next_btn =next_btn.subsample(2,2)

back_btn = PhotoImage(file=r'C:\Users\USER\NEW BUTTONS 5\tot_v8\Button images\icons8-back-to-100 (2).png')
...
l123 = Label(page1,text='Scaling Object Diameter',font="Calibri 30 ",background='grey',fg='white')
l123.grid(row=0,column=3,columnspan=9,sticky='ns')


l1 = Label(page1,text='Diameter :',font="Calibri 24 ",background='grey')
l1.grid(row=1,column=3,columnspan=4,sticky='ns')



e1 = Entry(page1,width=10,bg='white',fg='black',font=('Calibri', 24,''))
e1.grid(row=2,column=4,sticky='n',columnspan=3,padx=100)


l11 = Label(page1,text='cm',font="Calibri 24 ",background='grey')
l11.grid(row=2,column=6,sticky='n')

l2 = Label(page1,text='Scale down by :',font="Calibri 24 ",background='grey')
l2.grid(row=3,column=3,columnspan=4,sticky='ns')

e2 = Entry(page1,width=10,bg='white',fg='black',font=('Calibri', 24,''))
e2.grid(row=4,column=4,columnspan=3,sticky='n')

ball_btn = PhotoImage(file=r'C:\Users\USER\NEW BUTTONS 5\tot_v8\Button images\button_ball-length-detection (4).png')
...
bt4 = Button(page1,text ='Next',command =lambda:show_page(page2),image=next_btn,width=70,height=70,borderwidth=0,bg='grey',activebackground='grey')
bt4.grid(row=7,column=7,sticky='e',columnspan=3)

bt47 = Button(page1,text ='Back',command =lambda:show_page(page0),image=back_btn,width=70,height=70,borderwidth=0,bg='grey',activebackground='grey')
...
ball_btn1 = PhotoImage(file=r'C:\Users\USER\NEW BUTTONS 5\tot_v8\Button images\button_view-result (2).png')
...
l12345 = Label(page2,text='Auto-Contouring',font="Calibri 34 ",background='grey',fg='white')
l12345.grid(row=0,column=1,columnspan=3)



l3=Label(page2,text='Blur',font="Calibri 23 ",background='grey')
l3.grid(row=1,column=1,pady=10,sticky='w')
slider1 =Scale(page2,from_=25,to=500,orient=HORIZONTAL,troughcolor = 'white',background='grey',highlightbackground='black',length=260)
slider1.grid(row=1,column=2,pady=10)

l4=Label(page2,text='Canny',font="Calibri 23 ",background='grey')
l4.grid(row=2,column=1,sticky='w')
slider2 =Scale(page2,from_=100,to=255,orient=HORIZONTAL,troughcolor ='white',background='grey',highlightbackground='black',length=260)
slider2.grid(row=2,column=2,padx=20,pady=20)

l5=Label(page2,text='Size',font="Calibri 23 ",background='grey')
l5.grid(row=3,column=1,sticky='w')
slider3 =Scale(page2,from_=1,to=500,orient=HORIZONTAL,troughcolor = 'white',background='grey',highlightbackground='black',length=260)
slider3.grid(row=3,column=2,padx=20,pady=20)

l6=Label(page2,text='dst_va',font="Calibri 23 ",background='grey')
l6.grid(row=4,column=1,sticky='w')
slider4 =Scale(page2,from_=10,to=500,orient=HORIZONTAL,troughcolor = 'white',background='grey',highlightbackground='black',length=260)
...
bt41.grid(row=7,column=3,padx=4,pady=10,sticky='e')
...
l12378 = Label(page3,text='Manual Contouring',font="Calibri 34 ",background='grey',fg='white')
...
img12 = Image.open(r'C:\Users\USER\NEW BUTTONS 5\tot_v8\Button images\icons8-edit-100.png')
img12 = img12.resize((70,70), Image.ANTIALIAS)
draw_btn1 =  ImageTk.PhotoImage(img12)
#draw_btn1 = PhotoImage(file=r'C:\Users\USER\NEW BUTTONS 5\tot_v8\Button images\icons8-edit-100.png')
bt5= Button(page3,text ='Draw Fines',command =yoda,bg='white',image=draw_btn1,width=70,height=70,borderwidth=2,activebackground='grey')
bt5.grid(row=1,column=2,padx=100,columnspan=3,sticky='e')
l6255=Label(page3,text='Draw Fines',font="Calibri 20 ",background='grey')
l6255.grid(row=2,column=1,padx=100,sticky='n',columnspan=5)




img123 = Image.open(r'C:\Users\USER\NEW BUTTONS 5\tot_v8\Button images\icons8-delete-bin-100.png')
img123 = img123.resize((70,70), Image.ANTIALIAS)
delete_btn1 =  ImageTk.PhotoImage(img123)
#delete_btn1 = PhotoImage(file=r'C:\Users\USER\NEW BUTTONS 5\tot_v8\Button images\icons8-delete-bin-100.png')
bt51= Button(page3,text ='Delete',command =yoda_undo,bg='white',image=delete_btn1,width=70,height=70,borderwidth=2,activebackground='grey')
bt51.grid(row=3,column=2,padx=100,sticky='e',columnspan=3)
l62=Label(page3,text='Delete',font="Calibri 22 ",background='grey')
l62.grid(row=4,column=2,padx=100,sticky='ne',columnspan=3)




img1234 = Image.open(r'C:\Users\USER\NEW BUTTONS 5\tot_v8\Button images\icons8-lasso-tool-100.png')
img1234 = img1234.resize((70,70), Image.ANTIALIAS)
lasso_btn1 =  ImageTk.PhotoImage(img1234)
#lasso_btn1 = PhotoImage(file=r'C:\Users\USER\NEW BUTTONS 5\tot_v8\Button images\icons8-lasso-tool-100.png')
bt512= Button(page3,text ='lasso',command =yoda_lazzo,bg='white',image=lasso_btn1,width=70,height=70,borderwidth=2,activebackground='grey')
bt512.grid(row=5,column=2,padx=100,sticky='e',columnspan=3)
l621=Label(page3,text='Lasso',font="Calibri 23 ",background='grey')
...
report_btn1 = PhotoImage(file=r'C:\Users\USER\NEW BUTTONS 5\tot_v8\Button images\button_generate-report (3).png')

bt7= Button(page4,text ='Generate Report',background='#8A2BE2',fg='white',command =plot,font="Calibri 19 ",image=report_btn1,bg='grey',activebackground='grey',borderwidth=0)
bt7.grid(row=13,column=0,sticky='n')

l123789 = Label(page4,text='Histogram',font="Calibri 34 ",background='grey',fg='white')
l123789.grid(row=0,column=1,columnspan=4,sticky='ns')


l69=Label(page4,text="Select desired unit of measurement:",font="Calibri 17 ",background='grey')
l69.grid(row=1,column=2,pady=10,sticky='sw')

v = IntVar()
v.set("2")  # initializing the choice

rad45=Radiobutton(page4,text="Millimeters (mm)",padx = 20,bg='grey',font="Calibri 16 ",variable=v,value=1)
rad45.grid(row=2,column=2,sticky='nw')

rad451=Radiobutton(page4,text="Centimeters (cm)",padx = 20,bg='grey',font="Calibri 16 ",variable=v,value=2)
rad451.grid(row=3,column=2,sticky='nw')

rad452=Radiobutton(page4,text="Meters (m)",padx = 20,bg='grey',font="Calibri 16 ",variable=v,value=3)
rad452.grid(row=4,column=2,sticky='nw')

l345=Label(page4,text="Select number of bins for the graph output:",font="Calibri 17 ",background='grey')
l345.grid(row=6,column=2,sticky='nw')

var = IntVar()
var.set(10)
sca = Scale(page4 , variable = var ,from_=1, to=50,orient=HORIZONTAL,troughcolor = 'white',background='grey',highlightbackground='black',length=400)
sca.grid(row=7,column=2,sticky='nw')

l1234=Label(page4,text="Select LSL and USL values:",font="Calibri 17 ",background='grey')
...
bt4781.grid(row=13,column=1,sticky='w')
...
bt4812.grid(row=13,column=7,sticky='e')

report_btn2 = PhotoImage(file=r'C:\Users\USER\NEW BUTTONS 5\tot_v8\Button images\button_generate-merged-plot.png')
bt722= Button(page5,text ='Merge Plot',background='#8A2BE2',fg='white',command =merge,font="Calibri 19 ",image=report_btn2,bg='grey',activebackground='grey',borderwidth=0)
bt722.grid(row=8,column=2,sticky='n',columnspan=5)

l1237891 = Label(page5,text=' Merged Plot',font="Calibri 34 ",background='grey',fg='white')
