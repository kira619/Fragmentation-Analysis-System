...
def plot():
	...
	if fine_tot != float(0):
		...
		axs[1].text(-0.06, 0.03, s, horizontalalignment='left', fontsize = 'x-small')
...
bt4812.grid(row=13,column=8,sticky='e',padx=70)
...
bt722.grid(row=8,column=1,sticky='nw',columnspan=10)

l1237891 = Label(page5,text=' Merged Plot',font="Bahnschrift 34 bold",background='grey',fg='white')
